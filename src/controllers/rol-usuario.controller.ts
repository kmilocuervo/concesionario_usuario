...
export class RolUsuarioController {
  ...
  async find(
    ...
    return this.rolRepository.unroltienemuchosusuario(id).find(filter);
  }
  ...
  async create(
    ...
    return this.rolRepository.unroltienemuchosusuario(id).create(usuario);
  }
  ...
  async patch(
    ...
    return this.rolRepository.unroltienemuchosusuario(id).patch(usuario, where);
  }
  ...
  async delete(
    ...
    return this.rolRepository.unroltienemuchosusuario(id).delete(where);
  }
}
